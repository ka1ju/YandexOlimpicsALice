    ...
    if k == {}:
        if len(main_words) == 0:
            ...
            if len(all_accounts) > 3:
                ...
                return random.choice(variations1) + wordssss + \
                       ' и другие. Если вы хотите узнать имена всех кошельков,' \
                       ' скажите: "выведи все мои кошельки".', {'name': 0}
            else:
            ...
            if len(all_accounts) > 3:
                ...
                return random.choice(variations2) + wordssss + \
                       ' и другие. Если вы хотите узнать имена всех кошельков, скажите: ' \
                       '"выведи все мои кошельки".', {}
            else:
                wordssss = ', '.join(all_accounts)
                return random.choice(variations2) + wordssss, {}
        ...
        if len(main_words) == 0:
            if len(all_accounts) > 3:
                wordssss = ', '.join(all_accounts[:3])
                return random.choice(variations1) + wordssss + \
                       ' и другие. Если вы хотите узнать имена всех кошельков, скажите "выведи все мои кошельки".', \
                       {'name': 0}
            else:
                wordssss = ', '.join(all_accounts)
                return random.choice(variations1) + wordssss, {'name': 0}
            ...
            if len(all_accounts) > 3:
                wordssss = ', '.join(all_accounts[:3])
                return random.choice(variations2) + wordssss + \
                       ' и другие. Если вы хотите узнать имена всех своих кошельков,' \
                       ' скажите "выведи все мои кошельки".', {}
            else:
                wordssss = ', '.join(all_accounts)
                return random.choice(variations2) + wordssss, {}


print(information('выведи информацию о счёте', 'Test2', {}))
