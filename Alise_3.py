...
def information(general_frase, user_name, k):
    if k == {}:
        ...
        if not main_words:
            ...
            return random.choice(variations01), {'name': 0}
        ...
        if not main_words:
            ...
            return random.choice(variations11), {'name': 0}
...
# print(information('выведи информацию по счёту', 'Test2', {}))
# 1.05.2022, 20:32, by Mr_Hamstr
